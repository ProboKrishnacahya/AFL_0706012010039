...
<body class="bg-dark text-white">
    ...
    <footer class="navbar bg-black py-3 user-select-none">
        <div class="container">
            <div class="d-flex">
            ...
            <ul class="justify-content-end list-unstyled d-flex">
                <li class="ms-3"><a href="https://twitter.com/yuknonton"><svg class="bi"
                            width="24" height="24" fill="#db0000">
                            <use xlink:href="#twitter" />
                        </svg></a></li>
                <li class="ms-3"><a href="instagram.com/yuknonton"><svg class="bi" width="24"
                            height="24" fill="#db0000">
                            <use xlink:href="#instagram" />
                        </svg></a></li>
                <li class="ms-3"><a href="https://www.facebook.com/yuknonton"><svg class="bi"
                            width="24" height="24" fill="#db0000">
