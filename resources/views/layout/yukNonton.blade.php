    ...
    <footer class="navbar bg-black fixed-bottom user-select-none">
        <div class="container">
            ...
            <ul class="justify-content-end list-unstyled d-flex pt-2 mb-1">
                <li><a href="https://twitter.com/yuknonton"><i class="bi bi-twitter" style="font-size: 1.5rem;"></i></a></li>
                <li class="ms-3"><a href="instagram.com/yuknonton"><i class="bi bi-instagram" style="font-size: 1.5rem;"></i></a></li>
